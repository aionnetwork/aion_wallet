...
function bin2hex(str){ // .toString(16) only works up to 2^53
...
console.log(ethUtil);
    ...
    var returnData = [
        ...
        Buffer(this.pubKey, 'hex').toString('hex'),  //1
        ciphertext.toString('hex'),  //2
        iv.toString('hex'),            //3
        (opts.cipher || 'aes-128-ctr'),//4
        kdf,//5
        kdfparams.dklen.toString(), //6
        kdfparams.salt, //7
        kdfparams.n.toString(), //8
        kdfparams.r.toString(), //9

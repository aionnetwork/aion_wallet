...
ERROR_10                        :  '(error_11) Please enter a valid gas price. (Must be an integer. Try 20 aPLAT / 20000000000 WEI.)',
...
GAS_PRICE_Desc                  :  'NRG Price is the amount you pay per unit of NRG. `TX fee = NRG price * NRG limit` & is paid to miners for including your TX in a block. Higher the NRG price = faster transaction, but more expensive. Default is `41 aPLAT`.',
